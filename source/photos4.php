  ...
  <div class="container my-5">
    ...
    <section>
          <ul class="pagination justify-content-center my-5">
            <li class="page-item"><a class="page-link border border-warning bg-warning text-white" href="./photos3.html">Previous</a></li>
            ...
            <li class="page-item active"><a class="page-link border border-warning  text-warning" href="./photos4.html">4</a></li>
