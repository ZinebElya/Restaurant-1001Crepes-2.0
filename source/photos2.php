  ...
  <div class="container my-5">
      ...
      <div class="gallery justify-content-center d-flex my-5">
        <div class="row">
          <div class="col-12 col-lg-4">
            <img src= "./images/crêpes chocolat banane.jpg" alt="crêpes chocolat banane"  class="d-block w-100 my-5">
          </div>
          <div class="col-12 col-lg-4">
            <img src="./images/Crêpes roulé à la confiture de baies fraîches.jpg" alt="Crêpes roulé à la confiture de baies fraîches" class="d-block w-100 my-5">
          </div>
          <div class="col-12 col-lg-4">
            <img src="./images/Crêpes à la fleur d'oranger.jpg" alt="Crêpes à la fleur d'oranger" class="d-block w-100 my-5">
          </div>
        </div>
      </div>
    </section>
    ...
    <section>
          <ul class="pagination justify-content-center my-5">
            <li class="page-item"><a class="page-link border border-warning bg-warning text-white" href="./photos.html">Previous</a></li>
            <li class="page-item "><a class="page-link border border-warning text-warning " href="./photos.html">1</a></li>
            <li class="page-item active"><a class="page-link border border-warning text-warning" href="./photos2.html">2</a></li>
            ...
            <li class="page-item"><a class="page-link border border-warning bg-warning text-white" href="./photos3.html">Next</a></li>
          </ul>
    </section>
