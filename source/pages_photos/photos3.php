      ...
      <div class="gallery justify-content-center d-flex my-5">
        <div class="row">
          <div class="col-12 col-lg-4">
            <img src= "./images/milk-shake kiwi et menthe.jpg" alt="milk-shake kiwi et menthe"  class="d-block w-100 my-5">
          </div>
          <div class="col-12 col-lg-4">
            <img src="./images/milk-shake fraise banane chocolat.jpg" alt="milk-shake fraise banane chocolat" class="d-block w-100 my-5">
          </div>
          <div class="col-12 col-lg-4">
            <img src="./images/Milk-shake banane agrumes.jpg" alt="Milk-shake banane agrumes" class="d-block w-100 my-5">
          </div>
        </div>
      </div>
    </section>
